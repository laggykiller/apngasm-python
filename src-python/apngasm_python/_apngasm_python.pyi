...
class APNGAsm:
    ...
    def add_frame(self, frame: apngasm_python._apngasm_python.APNGFrame) -> int:
        """
    ...
    def add_frame_from_rgba(self, pixels_rgba: apngasm_python._apngasm_python.rgba, width: int, height: int, delay_num: int = 100, delay_den: int = 1000) -> int:
        """
        Adds an APNGFrame object to the vector.
        Not possible to use in Python. As alternative,
        Use create_frame_from_rgb() or create_frame_from_rgba(). Or manually,
    ...
    def disassemble(self, file_path: str) -> list[apngasm_python._apngasm_python.APNGFrame]:
        """
    ...
    def load_animation_spec(self, file_path: str) -> list[apngasm_python._apngasm_python.APNGFrame]:
        """
    ...
    def set_apngasm_listener(self, listener: Optional[apngasm_python._apngasm_python.IAPNGAsmListener] = None) -> None:
        """
        Sets a listener.
    ...
    def get_frames(self) -> list[apngasm_python._apngasm_python.APNGFrame]:
        """
...
class APNGFrame:
    ...
    @overload
    def __init__(self, pixels: apngasm_python._apngasm_python.rgb, width: int, height: int, trns_color: apngasm_python._apngasm_python.rgb, delay_num: int = 100, delay_den: int = 1000) -> None:
        """
    ...
    @overload
    def __init__(self, pixels: apngasm_python._apngasm_python.rgba, width: int, height: int, delay_num: int = 100, delay_den: int = 1000) -> None:
        """
...
def create_frame_from_rgb(pixels: Annotated[ArrayLike, dict(dtype='uint8', shape=(None, None, 3))], width: int, height: int, delay_num: int = 100, delay_den: int = 1000) -> apngasm_python._apngasm_python.APNGFrame:
    """
    Creates an APNGFrame from a bitmapped array of RBG pixel data.
...
def create_frame_from_rgb_trns(pixels: Annotated[ArrayLike, dict(dtype='uint8', shape=(None, None, 3))], width: int, height: int, trns_color: Annotated[ArrayLike, dict(dtype='uint8', shape=(3))], delay_num: int = 100, delay_den: int = 1000) -> apngasm_python._apngasm_python.APNGFrame:
    """
...
def create_frame_from_rgba(pixels: Annotated[ArrayLike, dict(dtype='uint8', shape=(None, None, 4))], width: int, height: int, delay_num: int = 100, delay_den: int = 1000) -> apngasm_python._apngasm_python.APNGFrame:
    """
    Creates an APNGFrame from a bitmapped array of RBGA pixel data.
