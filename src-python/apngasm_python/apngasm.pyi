...
class APNGAsmBinder:
    ...
    def frame_pixels_as_numpy(self, frame: int, new_value: Optional[numpy.typing.NDArray[Any]] = None) -> Optional[numpy.typing.NDArray[Any]]: ...
    ...
    def frame_palette(self, frame: int, new_value: Optional[numpy.typing.NDArray[Any]] = None) -> Optional[numpy.typing.NDArray[Any]]: ...
    def frame_transparency(self, frame: int, new_value: Optional[numpy.typing.NDArray[Any]] = None) -> Optional[numpy.typing.NDArray[Any]]: ...
